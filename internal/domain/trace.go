...
const (
	...
	StageAgentRequested  = "agent_reply_requested"
	StageAgentCompleted  = "agent_reply_completed"
	StageAgentFailed     = "agent_reply_failed"
	StageAgentRejected   = "agent_reply_rejected"
